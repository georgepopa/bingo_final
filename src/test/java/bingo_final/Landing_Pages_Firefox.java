...
public class Landing_Pages_Firefox extends TestCase {
	...
	public Landing_Pages_Firefox(String name) {
		super(name);
	...
	@Test
	public void testLandingPage_WitchesFirefox() throws MalformedURLException
	{
