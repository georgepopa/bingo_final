...
public class REGISTRATION_Chrome extends TestCase {
...
//	public final String URL = "http://" + USERNAME + ":" + ACCESS_KEY + "@ondemand.saucelabs.com:80/wd/hub";
	...
	public REGISTRATION_Chrome(String name) {
		super(name);
	...
	public void testInvalidPhoneFormat() throws MalformedURLException
	{
		...
		DesiredCapabilities caps = DesiredCapabilities.chrome();
		caps.setCapability("name", "Bingohall-signUp-InvalidPhone_Chrome");
		caps.setCapability("platform", "Windows 8");
	...
	public void testLongFormSignUp_withProxy() throws MalformedURLException
	{
	    ...
	    caps.setCapability("platform", "Windows 8");
	    caps.setCapability("version", "48.0");
	    caps.setCapability("name", "SignUp-LongForm-Proxy");
