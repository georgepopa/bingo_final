...
public class Landing_Pages_Edge extends TestCase {
	...
	public Landing_Pages_Edge(String name) {
		super(name);
	...
	@Test
	public void testLandingPage_WitchesEdge() throws MalformedURLException
	{
		 ...
		 driver.navigate().to("https://www.bingohall.ag/lp/290316/witches-hunt");
		 ...
		 driver.findElement(By.xpath(witchesPhone)).sendKeys("0555512345");
...
//	
	...
	public void testLandingPage_150FREE_Chrome() throws MalformedURLException
	{
		 ...
		 caps.setCapability("version", "13");
		 RemoteWebDriver driver = new RemoteWebDriver(new java.net.URL(URL), caps);
		 driver.navigate().to("https://www.bingohall.ag/lp/150free/150216");
		 ...
		 driver.findElement(By.xpath(F150_phone)).sendKeys("0555512345");
...
//	
	...
	public void testLandingPage_VampiresSlots_Chrome() throws MalformedURLException
	{
		 ...
		 caps.setCapability("version", "13");
		 RemoteWebDriver driver = new RemoteWebDriver(new java.net.URL(URL), caps);
		 driver.navigate().to("https://www.bingohall.ag/lp/88free/vampire-slots-slayers2");
		 WebDriverWait waitLoadPage = new WebDriverWait(driver,20);
		 waitLoadPage.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(witchesFormReg)));
		 driver.findElement(By.xpath(witchesUsername)).click();
		 String timeGenerated = String.valueOf(System.currentTimeMillis());
